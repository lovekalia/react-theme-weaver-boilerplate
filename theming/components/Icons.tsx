...
/**
 * JSDoc comment for DarkIcon
 * @param {React.SVGProps<SVGSVGElement>} props - React SVG props
 * @returns {JSX.Element} - The DarkIcon component
 */
...
/**
 * JSDoc comment for SunsetIcon
 * @param {React.SVGProps<SVGSVGElement>} props - React SVG props
 * @returns {JSX.Element} - The SunsetIcon component
 */
...
/**
 * JSDoc comment for SunriseIcon
 * @param {React.SVGProps<SVGSVGElement>} props - React SVG props
 * @returns {JSX.Element} - The SunriseIcon component
 */
...
/**
 * JSDoc comment for LightIcon
 * @param {React.SVGProps<SVGSVGElement>} props - React SVG props
 * @returns {JSX.Element} - The LightIcon component
 */
...
/**
 * JSDoc comment for OceanIcon
 * @param {React.SVGProps<SVGSVGElement>} props - React SVG props
 * @returns {JSX.Element} - The OceanIcon component
 */
...
/**
 * JSDoc comment for ForestIcon
 * @param {React.SVGProps<SVGSVGElement>} props - React SVG props
 * @returns {JSX.Element} - The ForestIcon component
 */
